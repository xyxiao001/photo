<template>
  ...
  <section class="page-content">
    <Search :placeholder="placeholder" choose="图标"></Search>
...
<script>
  ...
  export default {
    data () {
      return {
        placeholder: '什么图标呢 O(∩_∩)O~~',
        page: 1,
        imgs: [],
        url: 'https://pixabay.com/api/?key=2831718-1f9b7c1b490ec182487b38a60&lang=zh&q=icon&page='
      }
    },
    components: {
      Navbar,
